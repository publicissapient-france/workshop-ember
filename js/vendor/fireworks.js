var Fireworks = function(){
    ...
    self.init = function(){
        ...
        self.canvasContainer = $('<div></div>').attr({ id : "fireworksBg" })
        $('body').append(self.canvasContainer);
    ...
    while(initialLaunchCount--){
        setTimeout(function(){
            self.fireworks.push(new Firework(self.cw-100, self.ch, rand(50, self.cw-50), rand(50, self.ch-100)-50));
            self.fireworks.push(new Firework(100, self.ch, rand(50, self.cw-50), rand(50, 100)-50));
